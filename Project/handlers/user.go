...
// 	// 	"github.com/Eltanio-one/Hood-Booking-Microservice/data"
// 	"github.com/Eltanio-one/Hood-Booking-Microservice/session"
// )
...
// 		// test by printing the session cookies map
// 		u.l.Println(session.SessionTokens)
